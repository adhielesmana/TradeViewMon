...
async function runMigrations() {
    ...
    try {
        ...
        if (!existingTables.includes('auto_trade_settings')) {
            tablesToCreate.push(`
                CREATE TABLE auto_trade_settings (
                    ...
                    sl_tp_mode VARCHAR(20) NOT NULL DEFAULT 'pips',
        ...
        const alterStatements = [
            ...
            "ALTER TABLE auto_trade_settings ADD COLUMN IF NOT EXISTS sl_tp_mode VARCHAR(20) DEFAULT 'pips'",
            'ALTER TABLE auto_trade_settings ADD COLUMN IF NOT EXISTS stop_loss_value REAL DEFAULT 1',
